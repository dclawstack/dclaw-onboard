...
date: 2026-05-16
app_id: onboard
app_name: DClaw Onboard
category: HR
status: Future
---

# 📘 DClaw Onboard — Revised PRD v2.3
...
|---|---------|-------------|--------------|---------------------|
| P0.1 | **AI Onboard Copilot** | Personalized onboarding guide for every new hire. | LLM personalized-plan generation + FAQ answering | Generate 30-day plan in <2min; answer questions 24/7 |
| P0.2 | **Onboarding Checklists** | Role-specific checklists with deadlines and owners. | AI checklist-generation from role + seniority | 50+ checklist templates; auto-assign; track completion |
| P0.3 | **Document Collection** | Collect and verify I-9, tax forms, and policy acknowledgments. | AI document-validation + compliance checking | Upload 10+ doc types; auto-validate; e-signature integration |
| P0.4 | **Equipment Provisioning** | Track and ship equipment with IT integration. | AI provisioning-workflow + inventory check | Auto-create IT ticket; track shipment; confirm receipt |
...
| # | Feature | Description | AI Component | Acceptance Criteria |
|---|---------|-------------|--------------|---------------------|
| P1.1 | **Buddy Matching** | AI-match new hires with onboarding buddies. | Embedding-based compatibility + schedule matching | Match accuracy >75%; auto-schedule intro coffee |
| P1.2 | **Training Assignment** | Auto-assign role-specific training from DClaw Train. | AI training-curriculum mapping + gap analysis | Auto-enroll in 5 courses; track completion; send reminders |
| P1.3 | **Manager Dashboard** | Track onboarding progress and sentiment for direct reports. | AI sentiment analysis + risk-flagging | Weekly progress report; flag at-risk new hires; suggest interventions |
| P1.4 | **30-60-90 Day Reviews** | Structured check-ins at 30, 60, and 90 days. | AI review-template generation + goal-tracking | Auto-schedule check-ins; generate agenda; track goals |
...
| # | Feature | Description | AI Component | Acceptance Criteria |
|---|---------|-------------|--------------|---------------------|
| P2.1 | **Cultural Immersion** | Interactive content about company culture, values, and history. | AI content-personalization + quiz generation | Interactive modules; values quiz; team introductions |
| P2.2 | **Feedback Loop** | Collect and act on new-hire feedback. | AI feedback-synthesis + trend detection | Pulse at 7/30/90 days; synthesize themes; action plan |
| P2.3 | **Integration with HR** | Sync employee data with DClaw HR for seamless records. | API sync + change propagation | Auto-create employee record; sync benefits; update org chart |
| P2.4 | **Remote Onboarding** | Specialized track for remote hires with virtual social events. | AI virtual-event suggestion + icebreaker generation | Virtual coffee roulette; team trivia; remote equipment guide |
...
Inspired by Enboarder, Sapling, Workday Onboarding. Great onboarding improves retention by 82%.
