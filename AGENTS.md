...
**DClaw Onboard** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8041` (FastAPI)
- **Frontend Port:** `3041` (Next.js)
- **Database:** `dclaw_onboard` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3041`
