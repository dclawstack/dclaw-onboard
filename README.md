...
[![Status](https://img.shields.io/badge/status-P4%20Planned-10B981)](https://github.com/dclawstack/dclaw-onboard)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/onboard)

---

## Overview

DClaw Onboard is an AI-native hr application. It follows the standard DClaw architecture:
...
DClaw Onboard uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-onboard.git
cd dclaw-onboard
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_onboard"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-onboard.git /opt/dclaw-onboard
cd /opt/dclaw-onboard
docker compose up -d
```

The app will be available at `https://onboard.dclawstack.io`.

### Kubernetes

```bash
cd helm/dclaw-onboard
helm dependency build
helm upgrade --install dclaw-onboard . \
